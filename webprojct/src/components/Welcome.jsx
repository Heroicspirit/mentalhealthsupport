    ...
    <div>
      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          ...
          <p>
            Take the first step forwards better mental health. Our professional team is here to support you on your
            journey wellness.
          </p>
          <button id="get-help-btn" onClick={navigateToLogin}>
            Get Help Now
          </button>
        </div>
